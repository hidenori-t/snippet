...
my_time = (datetime.datetime(2069, 1, 28, 0, 0, 0) -
...
class Timer(Tk.Frame):
    def __init__(self,master=None): #各ボタンの配置
        ...
        b1 = Tk.Button(self, text=u'start', command=self.start, font='Helvetica, 12')
        b2 = Tk.Button(self, text=u'reset', command=self.stop, font='Helvetica, 12')
