...
untill_next_year = (datetime.datetime(2018, 1, 1) -
...
class Timer(Tk.Frame):
    ...
    def start(self):  # Startを押したときの動作
        self.started = True
        self.finish = time.time() + int(untill_next_year)
        self.count()
    ...
    def stop(self):  # 停止処理
        self.started = False
        self.tokei.config(text=untill_next_year)
